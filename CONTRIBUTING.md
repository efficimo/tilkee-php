...
``` bash
$ git clone git@gitlab.com:your-name/tilkee-php.git
...
``` bash
$ git remote add upstream git@gitlab.com:hbsresearch/tilkee-php.git
...
endpoint or requested / returned object, you will need to update the `tilkee-swagger.json` file instead of files in the `generated` directory.

See [README](README.md) to generate the files according to the specification.
