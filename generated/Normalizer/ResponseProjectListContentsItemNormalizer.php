...
class ResponseProjectListContentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ResponseProjectListContentsItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ResponseProjectListContentsItem' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\ResponseProjectListContentsItem();
