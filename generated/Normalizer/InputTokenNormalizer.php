...
class InputTokenNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Tilkee\\API\\Model\\InputToken') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Tilkee\API\Model\InputToken) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tilkee\API\Model\InputToken();
        if (property_exists($data, 'persons')) {
            $values = array();
            foreach ($data->{'persons'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Tilkee\\API\\Model\\InputTokenPersonsItem', 'json', $context);
            }
