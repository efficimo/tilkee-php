...
class TokenListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use DenormalizerAwareTrait;
    use NormalizerAwareTrait;
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'HbsResearch\\Tilkee\\API\\Model\\TokenListResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \HbsResearch\Tilkee\API\Model\TokenListResponse) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\TokenListResponse();
