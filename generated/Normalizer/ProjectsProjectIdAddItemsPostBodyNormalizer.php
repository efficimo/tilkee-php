...
class ProjectsProjectIdAddItemsPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ProjectsProjectIdAddItemsPostBody' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ProjectsProjectIdAddItemsPostBody' === get_class($data);
    }
