...
class ProjectListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use DenormalizerAwareTrait;
    use NormalizerAwareTrait;
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'HbsResearch\\Tilkee\\API\\Model\\ProjectListResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \HbsResearch\Tilkee\API\Model\ProjectListResponse) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\ProjectListResponse();
        ...
        if (property_exists($data, 'contents')) {
            ...
            foreach ($data->{'contents'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'HbsResearch\\Tilkee\\API\\Model\\Project', 'json', $context);
            }
