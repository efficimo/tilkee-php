...
class ResponseUserListContentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ResponseUserListContentsItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'HbsResearch\\Tilkee\\API\\Model\\ResponseUserListContentsItem' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\ResponseUserListContentsItem();
