...
class ProjectsProjectIdRemoveItemsPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Tilkee\\API\\Model\\ProjectsProjectIdRemoveItemsPostBody') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Tilkee\API\Model\ProjectsProjectIdRemoveItemsPostBody) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tilkee\API\Model\ProjectsProjectIdRemoveItemsPostBody();
