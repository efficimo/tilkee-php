...
class ResponseConnexionListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'HbsResearch\\Tilkee\\API\\Model\\ResponseConnexionList' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'HbsResearch\\Tilkee\\API\\Model\\ResponseConnexionList' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\ResponseConnexionList();
        ...
        if (property_exists($data, 'contents') && null !== $data->{'contents'}) {
            ...
            foreach ($data->{'contents'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'HbsResearch\\Tilkee\\API\\Model\\Connexion', 'json', $context);
            }
