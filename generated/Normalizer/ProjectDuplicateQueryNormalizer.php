...
class ProjectDuplicateQueryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use DenormalizerAwareTrait;
    use NormalizerAwareTrait;
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'HbsResearch\\Tilkee\\API\\Model\\ProjectDuplicateQuery') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \HbsResearch\Tilkee\API\Model\ProjectDuplicateQuery) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \HbsResearch\Tilkee\API\Model\ProjectDuplicateQuery();
        ...
        if (property_exists($data, 'should_duplicate_assignments')) {
