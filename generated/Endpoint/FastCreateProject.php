...
class FastCreateProject extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    /**
     ...
     * {@inheritdoc}
     *
     * @throws \HbsResearch\Tilkee\API\Exception\FastCreateProjectBadRequestException
     * @throws \HbsResearch\Tilkee\API\Exception\FastCreateProjectUnauthorizedException
     *
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \HbsResearch\Tilkee\API\Exception\FastCreateProjectBadRequestException();
        }
        if (401 === $status) {
            throw new \HbsResearch\Tilkee\API\Exception\FastCreateProjectUnauthorizedException();
        }
    }
}
